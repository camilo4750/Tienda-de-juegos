            ...
            <?php if (isset($_SESSION['User'])) : ?>
                ...
                <?php else : ?>
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?= baseUrl ?>Products/allProducts" class="btn btn-fixed mx-5" type="button">VER TODOS LOS PRODUCTOS</a>
                    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <?php while ($currentEvent = $ongoing->fetch_object()) : ?>
                <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 col-xxl-3 ml-auto">
    ...
    <div class="container-fluid">
        ...
        <div class="row bg-light justify-content-center">
            ...
            <?php while ($TIDING = $TIDINGS->fetch_object()) : ?>
                <div class="col-sm-12 col-md-12 col-lg-9 col-xl-6 col-xxl-3">
                    <div class="card mb-3 shadow">
                        <div class="row g-0">
                            <div class="col-md-5">
                                <div class="" style="height: 100%; width: 100%;">
                                    <img src="<?= baseUrl ?>uploads/Tidings/<?= $TIDING->image ?>" class="img-fluid rounded-start p-0" style="height: 100%; width: 100%;" alt="...">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="card-body">
